...
// The RandomX key is derived from the hash of an earlier block. Rotates every 2048 blocks with a
...
// Does this height use the fixed initial launch seed? (heights 0..63).
...
// This is the caching key: two heights with the SAME epoch share the RandomX cache/dataset,
...
// True at block 0 (startup) and at every boundary 64 + k*2048. When true, the
